...
%     qn3(i) = qn3(i-1) + (1 / (M3*w3)) * (0.001 * ((VV(:,3)' * (ACC_el(i, 2) * [1;1;1])) * sin(w3 * (55 - i * 0.001))));
    qn1(i) = qn1(i-1) + (1 / (M1*w1)) * (0.001 * ((VV(:,1)' * (ACC_el(i, 2) * [1;1;1])) * sin(w1 * (i * 0.001))));
    qn2(i) = qn2(i-1) + (1 / (M2*w2)) * (0.001 * ((VV(:,2)' * (ACC_el(i, 2) * [1;1;1])) * sin(w2 * (i * 0.001))));
    qn3(i) = qn3(i-1) + (1 / (M3*w3)) * (0.001 * ((VV(:,3)' * (ACC_el(i, 2) * [1;1;1])) * sin(w3 * (i * 0.001))));
